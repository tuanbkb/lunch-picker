...
const MODE_OPTIONS: {
  ...
  },
  {
    ...
    description:
      "Chỉ xét món đã có phiếu; món nhiều phiếu hơn có xác suất trúng cao hơn.",
  },
  {
    value: "allFoods",
    label: "Ngẫu nhiên tất cả món",
    description:
      "Bốc thăm đều giữa mọi món trong danh sách, không xét phiếu bầu.",
  },
];
  ...
  return (
    <Paper
      ...
      sx={{
        ...
        position: "relative",
        transition:
          "transform 120ms ease, border-color 120ms ease, box-shadow 120ms ease, opacity 200ms ease, background-color 120ms ease",
    ...
    <Stack spacing={3}>
      ...
      {phase === "done" && winner && (
        ...
        >
          ...
          <Typography
            component="div"
            sx={{ fontSize: 64, lineHeight: 1, mt: 1 }}
          >
            {winner.emoji}
          </Typography>
